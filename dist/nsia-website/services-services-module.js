...
var NsiaServicesService = /** @class */ (function () {
    function NsiaServicesService(http, dataService) {
        this.http = http;
...
module.exports = ".details .attachment {\r\n  width: -webkit-fit-content;\r\n  width: -moz-fit-content;\r\n  width: fit-content;\r\n  background-color: rgba(225, 225, 225, 0.3);\r\n  padding: 4px;\r\n  color: #282560 !important;\r\n  font-size: 18px;\r\n  margin: 2px 0px;\r\n  transition: background .2s ease-in-out;\r\n}\r\n\r\n.details .attachment:hover {\r\n  background-color: rgba(225, 225, 225, 0.719);\r\n\r\n}\r\n\r\n.details a {\r\n  text-decoration: none !important;\r\n  color: #282560 !important;\r\n}\r\n\r\n.details a:hover {\r\n  color: #282560 !important;\r\n}\r\n\r\n.details .attachment img {\r\n  width: 14px;\r\n  height: 15px;\r\n  margin: 0px 4px;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/services/services-home/services-home.component.html":
/*!*********************************************************************!*\
  !*** ./src/app/services/services-home/services-home.component.html ***!
  \*********************************************************************/
/*! no static exports found */
...
var ServicesHomeComponent = /** @class */ (function () {
    ...
    ServicesHomeComponent.prototype.getDeputyDetails = function (deputyType, tag) {
        ...
        this.nsiaServices.getDuptyDetails(deputyType, tag, customParams).subscribe(function (data) {
            if (data[0]) {
                ...
                console.log('Service data: ', _this.contents);
    ...
    ServicesHomeComponent.prototype.styleDetailsLink = function (data) {
        ...
        if (data.hasOwnProperty('content')) {
            ...
            if (jquery__WEBPACK_IMPORTED_MODULE_5__(details).has('a')) {
                ...
                jquery__WEBPACK_IMPORTED_MODULE_5__(details).find('a').parent().addClass('attachment');
                jquery__WEBPACK_IMPORTED_MODULE_5__(details).find('a').parent().prepend('<img src="../../../assets/images/pdf.png" alt="pdf">');
            }
    ...
    ServicesHomeComponent.prototype.getDeputyDepartments = function (deputyType, tag) {
        ...
        this.nsiaServices.getDuptyDetails(deputyType, tag, customParams).subscribe(function (data) {
            if (tag === 'department') {
                ...
                console.log('Departments data: ', _this.deputyDepartments);
            }
            else {
                _this.deputyHeadships = data;
                _this.headshipsFetched = true;
                console.log('Headships data: ', _this.deputyHeadships);
            }
    ...
    ServicesHomeComponent.prototype.getDepartmentDetails = function (id, el, depType) {
        ...
        console.log(jquery__WEBPACK_IMPORTED_MODULE_5__(el).closest('.m-item-c').attr('aria-expanded'));
        var customParams = [];
        var flag = false;
    ...
    ServicesHomeComponent.prototype.getProvinceDetails = function (id) {
        ...
        this.nsiaServices.getProvinceDetails(id, customParams).subscribe(function (data) {
            ...
            // this.contents.content.rendered = this.nsiaServices.htmlToPlaintext(this.contents.content.rendered);
            console.log(id + ' data:', _this.contents);
        });
    };
    ...
    ServicesHomeComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./services-home.component.html */ "./src/app/services/services-home/services-home.component.html"),
